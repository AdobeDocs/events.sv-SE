...
description: Adobe Experience Manager as a Cloud Service Release Overview Video 2023.6.0Funktionerna i den här versionen fokuserar på Experience Manager Assets innovationer och inkluderar följande - Nytt användargränssnitt för DAM-sökning Förbättrat 3D-resurshantering Metadatahanteringsförbättringar AEM [!DNL Assets] + [!DNL Frame io] -integrering
