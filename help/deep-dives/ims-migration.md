...
description: IMS-migreringen för Marketo-användare till Adobe-plattformen innefattar detaljerade steg, förberedelser och kommunikation, med ändringar efter migreringen och resurser för support och kommande evenemang.
feature: Reporting
...
* **Användarmigrering** Användare migreras sedan, med fokus på att se till att de har Adobe ID:n som matchar deras Marketo-inloggningsmeddelanden.
...
* Tillgång till support, utbildning, dokumentation och community via Adobe Experience League.
...
**Kommande event** Flera möten och händelser för användargrupper har markerats, bland annat virtuella sessioner och personliga sessioner på olika platser, samt Adobe Summit i mars 2025.
