...
| **PANEL- Beyond Borders: Projection for Future Commerce** | Paneldiskussion med Allyce Truscott från Adobe om utmaningar och lösningar för onlineföretag i dagens ekonomiska klimat. | <ul><li>Allyce Truscott - Head of New Business - Digital Experience</li><li> Carolina de Figuerido - Krispy Kreme</li><li>Hussein Moustafa - Ozzy Tires</li><li>Haig Kayserian - DigitDirect</li></ul> | [Titta på videon](./panel-beyond-borders.md) |
| **Experience Evolution: Commerce, Data och You** | En översikt och demonstration av personalisering för Commerce med [!DNL Real-Time Customer Data Platform], [!DNL Journey orchestration] och den integrerade Adobe [!DNL Experience Platform] | <ul><li>Mike Lynch - Enterprise [!DNL Commerce] Specialist, Adobe</li></ul> | [Titta på videon](./experience-evolution.md) |
...
| **Nästa generations Commerce: The Rise of Gen AI Applications** | Översikt och demonstrationer av AI i Commerce, Adobe senaste generativa AI till [!DNL Adobe Express] och hur det kan utnyttjas för e-handel och innehållsteam i verkligheten. | <ul><li>Eroka O&#39;Connor - Senior Solution Consultant, Adobe</li></ul> | [Titta på videon](./next-gen-commerce.md) |
...
| **Blixthastighet: Adobe edge delivery service** | Den senaste informationen och demonstrationen om Adobe blixtsnabbt Edge Delivery Services via Adobe Experience Manager och Adobe Commerce | <ul><li>Kam Radhakrishnan - Senior Solution Engineer, Adobe</li></ul> | [Titta på videon](./lightning-speed.md) |
...
| **Symphony för flera kanaler: Orchestrating Commerce Excellence** | En pratstund med Matt Palmer på Adobe om hur DotDigital driver innovation, personalisering och personlig kommunikation i samarbete med Adobe Commerce | <ul><li> Matt Palmer - Senior Partner Sales Manager, Adobe</li><li>Graham Bell - chef för ANZ Sales, DotDigital</li></ul> | [Titta på videon](./cross-channel-symphony.md) |
