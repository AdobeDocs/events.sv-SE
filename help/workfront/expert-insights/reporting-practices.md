...
* **Artikel** - [Beräknade datauttryck]&#x200B;(https://experienceleague.adobe.com/docs/workfront/using/reporting/reports/calculated-custom-data/calculated-data-expressions.html?lang=en#:~:text=Du kan använda datauttryck som genererar ett nytt fält.&amp;text=Om du vill ha mer information om hur du skapar data i ett anpassat formulär.)
