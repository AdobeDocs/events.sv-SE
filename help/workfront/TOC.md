...
+ Workshop Rewind {#workshop-rewind}
   ...
   + Arbetsflöde {#workflow}
      ...
      + [Förbättrad anpassad Forms och lokalisering](workshop-rewind/workflow/enhanced-logic-localization.md)
      ...
      + [Vi presenterar avancerade företagsåtgärder](workshop-rewind/workflow/intro-aeo.md)
      + [Lektioner från Workfront-administratörer](workshop-rewind/workflow/lessons-learned-admins.md)
      + [Mastering av affärsregler](workshop-rewind/workflow/business-rules.md)
      ...
      + [Workfront Admin - 10 lektioner](workshop-rewind/workflow/workfront-admin-10-lessons.md)
...
+ Expertinsikter {#expert-insights}
   ...
   + [En instans utveckling](expert-insights/evolution-of-an-instance.md)
