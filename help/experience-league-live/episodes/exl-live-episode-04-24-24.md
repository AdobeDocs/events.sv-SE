...
**Detaljer**: Kodbaserad upplevelsekanal i Adobe Journey Optimizer avslöjar enorma möjligheter och nya användningsexempel för varumärken som utvecklar sina personaliserings- och experimenteringsprogram. Den nya kanalen gör det möjligt för team att öka personaliseringskontrollen med kodbaserade HTML- eller JSON-åtgärder med möjlighet att ändra detaljerna i inbyggda applikationer. Kodbaserad Experience Channel utökar flexibiliteten och prestandan för implementeringar på klientsidan, serversidan, hybridservern och API-baserade applikationer.
...
**Fortsätt diskutera det här ämnet i Adobe Experience League [Community-posten](https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-discussions/experience-league-live-post-session-discussion-new-code-based/m-p/668305#M205){target="_blank"}.**
