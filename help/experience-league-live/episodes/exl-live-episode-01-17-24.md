...
Delta i Bryan, Eric och Doug och diskutera hur ni snabbt ska komma igång med Customer Journey Analytics (CJA). Du får lära dig att använda automatiserade processer för att flytta data och analyser från Adobe Analytics till CJA, samt allt du behöver tänka på under processen. Och de kommer förstås att ha en bra dos roliga tips och tricks på vägen.
...
* ADC tillåter att data från en rapportsserie kopieras till Adobe Experience Platform för analys, medan webben SDK skickar data direkt till Adobe Experience Platform.
...
* Anslutningar i Customer Journey Analytics gör det möjligt att kombinera olika datauppsättningar och analysera flera datakällor på ett och samma ställe.
...
* Det finns ett nytt verktyg som kallas&quot;komponentmigrering&quot; som gör att Adobe Analytics-administratörer kan migrera projekt till CJA.
* När du migrerar ett projekt flyttas alla komponenter i tabellerna, liksom alla segment eller beräknade värden, till CJA.
* Det finns en mappningsprocess där komponenter som inte finns i CJA kan mappas med&quot;catch-all&quot; eller härledda fält.
* Vi rekommenderar att du skapar en&quot;catch-all&quot; för element som inte finns i CJA och sedan redigerar dem i målprojektet.
* Tidigare trodde man att beräknade värden och segment måste återskapas när man migrerar till CJA, men nu finns det ett alternativ för att migrera dem.
