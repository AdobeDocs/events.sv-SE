  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6">
         Upptäck kommande och tidigare webbinarier och event som hjälper dig att bemästra GenStudio for Performance Marketing.</p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6">
            Lås upp Adobe Experience Cloud med Adobe expertledda tekniska sessioner, tillgängliga live och on-demand för smidig inlärning.</p>
      </div>
